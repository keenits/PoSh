...
Write-Host "Primary is reachable?"
Test-Connection $PrimaryDNSServer -Quiet -Count 1
Write-Host "Secondary is reachable?"
Test-Connection $SecondaryDNSServer -Quiet -Count 1
...
Write-Host "Public is reachable?"
Test-Connection 1.1.1.1 -Quiet -Count 1
}